...
if (!empty($id)) {
    $qrydel = "DELETE FROM familias WHERE id=:id";
    ...
    if($delete->execute()){
		...
		$ft = '../images/familia/'.$_GET['del'].".jpg";		 
		unlink($ft);	
   ...
   header("Location: ".$pg);
    ...
    $qry = "SELECT * FROM familias order by descricao ";
  ...
  `familias`.`descricao`,
  `familias`.`veiculo_id`,
  `veiculos`.`descricao` as veiculo,
  `veiculos`.`site`
FROM
  `familias`
  LEFT OUTER JOIN `veiculos` ON (`familias`.`veiculo_id` = `veiculos`.`id`)
  Order by `veiculos`.`site`, `familias`.`descricao` LIMIT $inicio,$registros";
   $resultado = $conn->prepare($qry);
   $resultado->execute();
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center">
                            ...
                            <a href="cad_familias.php" class="btn btn-success ml-3">Novo</a>
                        </div>
                                        ...
                                        <table class="table mb-0 thead-border-top-0">
				                            ...
				                            ?>
                                                ...
                                                <tr <?=$sel?>>
                                                    ...
                                                    <td><span class="js-lists-values-employee-name"><?php echo $tab['descricao']; ?></span></td>    
										            <td><?php echo $tab['site'].' - '.$tab['veiculo']; ?></small></td>
                                                    <td>
														<a href="ed_familias.php?id=<?=$tab['id']?>" class="text-muted"><i class="material-icons" >description</i></a>
