...
if($_GET['val']==''){
    $qry = "SELECT * FROM usuarios where id=".$_GET['id'];
                                    ...
                                    <form method="post" action="?val=s">
                                        <div class="was-validated">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nome_usuario" name="nome_usuario" placeholder="Nome" required="" value="<?=$tab['nome_usuario']?>" >
 									...
 									<div class="col-12 col-md-3 mb-3" style="float: left">
                                        ...
                                        <select id="nivel"  class="form-control" name='nivel'> 
                                            ...
                                            <option value="1" <?php if($tab['nivel']==1){?>selected=""<?php }?>>administrador</option>
                                            <option value="2" <?php if($tab['nivel']==2){?>selected=""<?php }?>>Usuario</option>
 									...
 									<div class="col-12 col-md-3 mb-3" style="float: left">
                                        ...
                                        <select id="ativo"  class="form-control" name='ativo'>
                                            <option value="1" <?php if($tab['ativo']==1){?>selected=""<?php }?>>Sim</option>
                                            <option value="0" <?php if($tab['ativo']==0){?>selected=""<?php }?>>Não</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="login" name="login" placeholder="login " required="" value="<?=$tab['login']?>">

                                                </div>
												
                                                <div class="col-12 col-md-4 mb-3">
                                                    <label for="senha">Senha</label>
                                                    <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha" required="" value="<?=$tab['senha']?>">

                                                </div>					
												
                                                <div class="col-12 col-md-4 mb-3">
                                                    <label for="celular">Email</label>
                                                    <input type="text" class="form-control" id="email" name="email" placeholder="email"  data-mask-selectonfocus="true" value="<?=$tab['email']?>">
