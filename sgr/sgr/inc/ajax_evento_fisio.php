...
if($tab_evento['status']==1){$status2='Compareceu'; $cor='#436EEE';}elseif($tab_evento['status']==2){$status2='Faltou'; $cor='#8B0000';}elseif($tab_evento['status']==3){$status2='Finalizado'; $cor='#afedc2';}
...
echo '
                                ...
                                <dt class="col-sm-2">Status Atual</dt>
                                <dd class="col-sm-9" style="color='.$cor.';">'.$status2.'</dd>  									
									
                                </div>									
								
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Evolução</label>
                                    <div class="col-sm-10">
